	...
	<div class="grid-container">
		...
		<div class="grid-20">
			<ul class="social-media">
				...
				<li><a target="_blank" href="http://forums.bukkit.org/threads/269253/"><span class="fa-stack"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-comment fa-stack-1x black"></i></span></a></li>
			</ul>
		</div>
	</div>
</footer>
