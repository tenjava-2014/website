...
<div id="wrapper">
	...
	<div id="point-ticker">
		<div class="grid-container">
			...
			<div class="grid-20 tablet-grid-20">Total Signups: <span>{{ $appsData->count }} participants</span></div>
		</div>
	</div>
	@yield('content')
	<div class="push"></div>
	...
	<div class="grid-container">
		...
		<div class="grid-20">
			<ul class="social-media">
				...
				<li><a target="_blank" href="http://forums.bukkit.org/threads/269253/"><span class="fa-stack"><span class="fa-stack"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-comment fa-stack-1x black"></i></span></span></a></li>
			</ul>
		</div>
	</div>
</footer>
