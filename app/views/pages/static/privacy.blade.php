...
<div class="content-back">
    <div class="grid-container">
        <div class="grid-100">
            ...
            <p>When you signup as a participant or apply as a judge we use GitHub to collect some information from you.
                We use the 'user:email' scope by default which gives us a list of email addresses from your GitHub
                account. This includes non-primary emails. We use this data for a number of reasons:</p>
            <ul>
            ...
            <p>We'll also need to use this information if we need to get in contact with a participant due to confusion
                ...
                info. Email data will not be shared with any third-parties.</p>
            ...
            <p>We ask judges to provide an IRC nick, GMail address and Minecraft username. This is in addition to a
                BukkitDev username. The IRC nick will be used to invite you to our
                communication channel(s) if your application is successful. We'll use the GMail address to invite you to
                any documents or spreadsheets if your application is successful. Your Minecraft username will be checked
                for validity and used to allow you to use our testing server(s). For participants and judges, the GitHub
                username used to authenticate the application will also be stored.</p>
            ...
            <p>To ensure applicants and participants have a choice in what information they choose to provide, we have
                made it possible to opt-out of email sharing. If you choose to opt-out, we will not have access to your
                GitHub emails. This applies to participants and judge applications. Judge applicants must still provide
                a GMail address to be considered. To opt-out, simply use the link below:</p>
